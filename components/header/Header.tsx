...
export default function Header() {
  return (
    <header className="bg-gradient-to-r from-custom-olive-green via-custom-light-olive-green to-custom-lime-green w-full h-fit rounded-xl p-5 my-5 sticky top-5 z-[1000]">
